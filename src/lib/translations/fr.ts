...
export const fr: Catalogue = {
  ...
  'voice.a11yPause': 'Mettre la note vocale en pause',
  'voice.a11yPlay': 'Écouter la note vocale de {name}',
  ...
  'photo.addHint': 'Un visage rend un souvenir bien plus facile à situer',
  'photo.change': 'Changer la photo',
  'photo.remove': 'Supprimer la photo',
  'topics.heading': 'Qu’ajouter ?',
  'topics.thinking': 'Recherche de questions…',
  'editSection.placeholder': 'Racontez l’histoire ici…',
  'editSection.saveFailed': 'Impossible d’enregistrer',
  'chapterPrompt.early_life': 'Où a-t-elle grandi, et à quoi ressemblait la maison ?',
  'chapterPrompt.career': 'Quel métier a-t-elle exercé, et de quoi était-elle fière ?',
  'chapterPrompt.family': 'Qui sont ses proches, et comment se sont-ils rencontrés ?',
  'chapterPrompt.personality': 'Comment est-elle — drôle, têtue, généreuse, discrète ?',
  'chapterPrompt.favorites': 'Musiques, plats, lieux préférés, ce vers quoi elle revenait toujours.',
  'chapterPrompt.stories': 'L’histoire que cette famille raconte encore et encore.',
